...
threshold_fit_results <- fit_thresholds(wd, delta_gaps_thresholds, sim_unif_dataset_sizes)
...
dispersion_fit_results <- fit_dispersions(wd, mean_dispersions, sim_unif_dataset_sizes)
...
(clusters_a <- sc_cluster_data_long %>% filter(prop_type=="subthr") %>% distinct(id, property, k_est) %>% 
...
(clusters_b <- sc_cluster_data_long %>% filter(prop_type=="suprathr") %>% 
